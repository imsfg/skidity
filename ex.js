    ...
    fetch(
      "https://api.openweathermap.org/data/2.5/forecast?q=New Delhi&units=metric&appid=24dbfd6a85e374466b31f5579d96aa6f"
    )
      .then((response) => response.json())
      .then((data) => {
        for (i = 0; i < 5; i++) {
          document.getElementById("day" + (i + 1) + "min").innerHTML =
            Number(data.list[i + 7 * i].main.temp_min).toFixed(1) + "°";
        }
        for (i = 0; i < 5; i++) {
          document.getElementById("day" + (i + 1) + "max").innerHTML =
            Number(data.list[i + 7 * i].main.temp_max).toFixed(1) + "°";
        }
        for (i = 0; i < 5; i++) {
          document.getElementById("img" + (i + 1)).src =
            "http://openweathermap.org/img/wn/" +
            data.list[i + 7 * i].weather[0].icon +
            ".png";
        }
        for (i = 0; i < 6; i++) {
          document.getElementById("x" + (i + 1)).innerHTML = data.list[
            i
          ].dt_txt.slice(10, 19);
        }
        for (i = 0; i < 6; i++) {
          document.getElementById("z" + (i + 1)).innerHTML =
            Number(data.list[i].main.temp).toFixed(1) + "°C";
        }
        for (i = 0; i < 6; i++) {
          document.getElementById("y" + (i + 1)).src =
            "http://openweathermap.org/img/wn/" +
            data.list[i].weather[0].icon +
            ".png";
        }
        document.getElementById("ptanhi").innerHTML =
          data.list[0].weather[0].description;
        document.getElementById("temp").innerHTML = data.list[0].main.temp + "°C";
        document.getElementById("pres").innerHTML =
          data.list[0].main.pressure + " inHg";
        ...
        if (city == undefined) {
          ...
          fetch(
            "https://api.openweathermap.org/data/2.5/forecast?q=" +
              city +
              "&units=metric&appid=24dbfd6a85e374466b31f5579d96aa6f"
          )
            .then((response) => response.json())
            .then((data) => {
              document.getElementById("ptanhi").innerHTML =
...
fetch(
  "https://api.openweathermap.org/data/2.5/forecast?q=Kolkata&units=metric&appid=24dbfd6a85e374466b31f5579d96aa6f"
)
  .then((response) => response.json())
  .then((data) => {
...
fetch(
  "https://api.openweathermap.org/data/2.5/forecast?q=London&units=metric&appid=24dbfd6a85e374466b31f5579d96aa6f"
)
  .then((response) => response.json())
  .then((data) => {
...
fetch(
  "https://api.openweathermap.org/data/2.5/forecast?q=Chicago&units=metric&appid=24dbfd6a85e374466b31f5579d96aa6f"
)
  .then((response) => response.json())
  .then((data) => {
...
fetch(
  "https://api.openweathermap.org/data/2.5/forecast?q=Paris&units=metric&appid=24dbfd6a85e374466b31f5579d96aa6f"
)
  .then((response) => response.json())
  .then((data) => {
...
fetch(
  "https://api.openweathermap.org/data/2.5/forecast?q=Sydney&units=metric&appid=24dbfd6a85e374466b31f5579d96aa6f"
)
  .then((response) => response.json())
  .then((data) => {
